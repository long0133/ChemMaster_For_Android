 ...
 */
public class CYLPreference {

    private static final String FILE_NAME = "app_data";
    private static SharedPreferences mSharedPreferences;// 单例
    private static CYLPreference instance;// 单例

    private CYLPreference(Context context) {
    ...
    public static synchronized void init(Context context) {
        if (instance == null) {
            instance = new CYLPreference(context);
        }
    }
     ...
     * @return
     */
    public static CYLPreference getInstance() {
        if (instance == null) {
